...
function circularHeat() {
    ...
    var numSegments = 24;
    var innerRadius = 80; 
	// the length of the radius of the donut econtent is: (width-innerRadius*2) / 2
	// the length of each segment is: the radius of the donut econtent / the number of layers
